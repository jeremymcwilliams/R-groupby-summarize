...
Examine one of the datasets (you can just print it in a code block, or use the head() function on one). What kinds of questions might you ask? How could group by/summarize help you answer them (or at least show patterns, etc.)
